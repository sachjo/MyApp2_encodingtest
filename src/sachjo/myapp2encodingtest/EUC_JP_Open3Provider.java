...
public class EUC_JP_Open3Provider extends CharsetProvider {

	public static final String CHARSET_NAME = "EUC-JP-Open3";
	public static final String CHARSET_ALIAS = "EUC_JP-Open3";
	...
	public EUC_JP_Open3Provider() {
		charset = new EUC_JP_Open3(CHARSET_NAME, new String[] {CHARSET_ALIAS});
	}
	 ...
	 * 
	 */
	public static class EUC_JP_Open3 extends Charset {

		private final Charset base = Charset.forName("x-eucJP-OpenExt");

		public EUC_JP_Open3(String canonicalName, String[] aliases) {
		...
		public CharsetDecoder newDecoder() {
			return new EUC_JP_Open3Decoder(this, base.newDecoder());
		}

		public CharsetEncoder newEncoder() {
			return new EUC_JP_Open3Encoder(this, base.newEncoder());
		}
	}
	 ...
	 * 
	 */
	public static class EUC_JP_Open3Encoder extends CharsetEncoder {

		private final CharsetEncoder base;

		public EUC_JP_Open3Encoder(Charset cs, CharsetEncoder base) {
	 ...
	 * 
	 */
	public static class EUC_JP_Open3Decoder extends CharsetDecoder {

		private final CharsetDecoder base;

		public EUC_JP_Open3Decoder(Charset cs, CharsetDecoder base) {
