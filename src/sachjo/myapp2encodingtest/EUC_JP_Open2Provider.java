...
public class EUC_JP_Open2Provider extends CharsetProvider {

	public static final String CHARSET_NAME = "EUC-JP-Open2";
	public static final String CHARSET_ALIAS = "EUC_JP-Open2";
	...
	public EUC_JP_Open2Provider() {
		charset = new EUC_JP_Open2(CHARSET_NAME, new String[] {CHARSET_ALIAS});
	}
	 ...
	 * 
	 */
	public static class EUC_JP_Open2 extends Charset {

		private final Charset base = Charset.forName("x-eucJP-OpenExt");

		public EUC_JP_Open2(String canonicalName, String[] aliases) {
		...
		public CharsetDecoder newDecoder() {
			return new EUC_JP_Open2Decoder(this, base.newDecoder());
		}

		public CharsetEncoder newEncoder() {
			return new EUC_JP_Open2Encoder(this, base.newEncoder());
		}
	}
	 ...
	 * 
	 */
	public static class EUC_JP_Open2Encoder extends CharsetEncoder {

		private final CharsetEncoder base;

		public EUC_JP_Open2Encoder(Charset cs, CharsetEncoder base) {
	 ...
	 * 
	 */
	public static class EUC_JP_Open2Decoder extends CharsetDecoder {

		private final CharsetDecoder base;

		public EUC_JP_Open2Decoder(Charset cs, CharsetDecoder base) {
